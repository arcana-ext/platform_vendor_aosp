...
PRODUCT_COPY_FILES += \
    ...
    vendor/aosp/prebuilt/common/etc/permissions/system/vendor.lineage.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml \
